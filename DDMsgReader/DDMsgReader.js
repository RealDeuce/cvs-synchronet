// $Id: DDMsgReader.js,v 1.126 2019/04/26 01:22:20 nightfox Exp $
	...
	*/
	...
	if (numChars > 0)
	{
		...
		for (var i = 0; i < numLeft; ++i)
			this.msgListLightbarModeHelpLine = "л" + this.msgListLightbarModeHelpLine;
		...
		for (var i = 0; i < numRight; ++i)
			this.msgListLightbarModeHelpLine += "л";
	}
}
...
function DigDistMsgReader_SelectMsgArea_Traditional()
{
	...
	*/
	...
	while (continueChoosingMsgGroup)
	{
		...
		this.ListMsgGrps();
		console.crlf();
		console.print("\1n\1b\1hў \1n\1cWhich, \1hQ\1n\1cuit, or [\1h" +
...
function DigDistMsgReader_showChooseMsgAreaHelpScreen(pLightbar, pClearScreen)
{
   ...
   console.crlf();
   console.print("\1k\1hФФФФФФФФФФФФФФФФФФФФФФФФФФФФФ");
   console.crlf();
