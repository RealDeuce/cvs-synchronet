 ...
 * --
 * $Id: appWrapper.java,v 1.1 2005/09/25 22:40:20 rswindell Exp $
 ...
 *     applet window.<P>
 * </DL>
 * @version $Id: appWrapper.java,v 1.1 2005/09/25 22:40:20 rswindell Exp $
...
public class appWrapper extends Applet implements AppletStub, Runnable
{
  ...
  {
    String info = "appWrapper: $Id: appWrapper.java,v 1.1 2005/09/25 22:40:20 rswindell Exp $\n";
    if(applet != null)
